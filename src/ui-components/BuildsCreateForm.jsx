...
export default function BuildsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setRoll_value(initialValues.roll_value);
    setErrors({});
  };
  const validations = {
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Builds(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "BuildsCreateForm")}
      {...rest}
    >
      <TextField
        label="Game id"
